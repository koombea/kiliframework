(function ($) {
  ...
  var ACFFCM = {
    ...
    addModal: function ($layout) {
      ...
      $layout.find("> .acf-fc-layout-controls > a.-plus").remove();
    ...
    open: function () {
      ...
      var updateButton = $('<input name="save" type="submit" class="acf-button-update button" id="publish-kili" value="Update">');

      $layout.find('.acf-fc-modal-title').html(caption).append(a).append(updateButton);
